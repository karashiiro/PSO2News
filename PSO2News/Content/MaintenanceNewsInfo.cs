...
namespace PSO2News.Content
{
    public class MaintenanceNewsInfo : NewsInfo
    {
        ...
        public async Task<MaintenanceNewsInfo> Parse(CancellationToken token)
        {
            ...
            content ??= page.DocumentNode.SelectSingleNode("//div[@id='newsBlock']"); // Old PSO2es wrappers
            ...
            catch (ArgumentOutOfRangeException) // One of the regexes matched junk; happens on https://pso2.jp/es/players/news/?id=6883&page=9
            {
                Unreadable = true;
                return this;
            }
